...
public class TwoSum {
    public static void main(String[] args) {
        ...
        PrintTool.printArray(twoSumIndex(nums, target));
        PrintTool.printArray(twoSumHash(nums, target));
        PrintTool.printArray(twoSumOneHash(nums, target));
...
/**
 ...
 target−nums[i]）是否存在于表中。注意，该目标元素不能是
 n
 u
 m
 s
 ...
 O(n)， 所需的额外空间取决于哈希表中存储的元素数量，该表中存储了
 n
 n 个元素。
 ...
 O(n)， 所需的额外空间取决于哈希表中存储的元素数量，该表最多需要存储
 n
 n 个元素。
 */